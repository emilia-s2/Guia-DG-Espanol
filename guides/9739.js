...
module.exports = {
	...
	// 1 BOSS
	"s-739-1000-105-0": [{ "type": "text", "sub_type": "message", "message": "Girar + Respiracion", "message_RU": "Поворот + дыхание" }],
	"s-739-1000-308-0": [
	...
	"s-739-2000-120-0": [{ "type": "text", "sub_type": "message", "message": "Disparo de Atras", "message_RU": "Сзади" }],
...
//	"h-739-3001-30": [{ "type": "text", "sub_type": "message", "message": "Rugido forte breve...", "message_RU": "Скоро разоблачение..." }],
    "s-739-3000-201-0": [{ "type": "text", "sub_type": "message", "message": "Rugido Fuerte (Stun)", "message_TW": "出" },
