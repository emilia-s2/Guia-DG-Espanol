...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3106-1000-105-0": [{ type: "text", sub_type: "message", message: "Knockback Spin (Kaia)", message_ES: "Giro Atrás Empujón (KAIA)", check_func: () => combo_start === true }],
		"s-3106-1000-106-0": [
		...
		"s-3106-1000-512-0": [{ type: "text", sub_type: "message", message: "Turn | Spin", message_ES: "Turn | Girar" }],	
		
		"s-3106-1000-502-0": [{ type: "text", sub_type: "message", message: "Unleash", message_ES: "Liberar" }],
