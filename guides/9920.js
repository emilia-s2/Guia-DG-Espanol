...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	let SPAWNING_FIRST_CIRCLE_FLOWERS = [
		{ type: "text", class_position: "tank", sub_type: "message", message: "DERECHA | ENTRAR - SALIR (Donuts)", message_RU: "Вправо сейф > Волны внутрь" },
		{ type: "text", class_position: "dps", sub_type: "message", message: "IZQUIERDA | ENTRAR - SALIR (Donuts)", message_RU: "Влево сейф > Волны внутрь" },
		{ type: "text", class_position: "heal", sub_type: "message", message: "IZQUIERDA | ENTRAR - SALIR (Donuts)", message_RU: "Влево сейф > Волны внутрь" },
	...
	let SPAWNING_SECOND_CIRCLE_FLOWERS = [
		{ type: "text", class_position: "tank", sub_type: "message", message: "IZQUIERDA | SALIR - ENTRAR (Donuts)", message_RU: "Влево сейф > Волны наружу" },
		{ type: "text", class_position: "dps", sub_type: "message", message: "DERECHA | SALIR - ENTRAR (Donuts)", message_RU: "Вправо сейф > Волны наружу" },
		{ type: "text", class_position: "heal", sub_type: "message", message: "DERECHA | SALIR - ENTRAR (Donuts)", message_RU: "Вправо сейф > Волны наружу" },
	...
	return {
		...
		"s-920-1000-1130-0": [{ type: "text", sub_type: "message", message: "FULL | ENTRAR - SALIR", message_RU: "Общий > Внешний > Внутренний" }],
		...
		"s-920-1000-2130-0": [{ type: "text", sub_type: "message", message: "FULL | SALIR - ENTRAR", message_RU: "Общий > Внутренний > Внешний" }],
		...
		"s-920-2000-1113-0": [
		    { type: "text", sub_type: "message", message: "Derecha SLASH", message_RU: "Левая полоса", class_position: "tank" },  //Adicionado
			{ type: "text", sub_type: "message", message: "Izquierda SLASH", message_RU: "Левая полоса", class_position: "heal" }, //Adicionado
			{ type: "text", sub_type: "message", message: "Izquierda SLASH", message_RU: "Левая полоса", class_position: "dps" },  //Adicionado
		...
		"s-920-2000-1114-0": [
			{ type: "text", sub_type: "message", message: "Izquierda SLASH", message_RU: "Левая полоса", class_position: "tank" }, //Adicionado
			{ type: "text", sub_type: "message", message: "Derecha SLASH", message_RU: "Левая полоса", class_position: "heal" },  //Adicionado
			{ type: "text", sub_type: "message", message: "Derecha SLASH", message_RU: "Левая полоса", class_position: "dps" },   //Adicionado
		...
		"s-920-2000-1104-0": [{ type: "text", sub_type: "message", message: "Salto Aleatorio (stun)", message_RU: "Прыжок (стан)" }],
		"s-920-2000-1110-0": [
		...
		"s-920-2000-2104-0": [{ type: "text", sub_type: "message", message: "Salto Aleatorio (stun)", message_RU: "Прыжок (стан)" }],
		"s-920-2000-2110-0": [
		    { type: "text", sub_type: "message", message: "Frente Stun", message_RU: "Передний стан" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 176, 10, 270, 0, 3000] }  // Adicionado
		],
		...
		// Special attacks
		"s-920-2000-3119-0": [{ type: "text", sub_type: "message", message: "FUERA Seguro", message_RU: "Красный: Наружу сейф" }],
		...
		// Not enraged
		"s-920-3000-1315-0": [{ type: "text", sub_type: "message", message: "Empujar (Repeler)", message_RU: "Откид (кайа)" }],
		"s-920-3000-1107-0": [{ type: "text", sub_type: "message", message: "Salto Aleatorio (stun)", message_RU: "Прыжок (стан)" }],
		...
		// Enraged
		"s-920-3000-2204-0": [{ type: "text", sub_type: "message", message: "Haz de Energia", message_RU: "Волна" }],
		// heart thrust+anticlockwise spin+right swipe+AOEs from out to in
		...
		"s-920-3000-1310-0": [{ type: "text", sub_type: "message", message: "Olas de Agua", message_RU: "Копии: волны" }], //Adicionado
		"s-920-3000-1311-0": [{ type: "text", sub_type: "message", message: "Olas de Agua", message_RU: "Копии: волны" }], //Adicionado
		"s-920-3000-1312-0": [{ type: "text", sub_type: "message", message: "Olas de Agua", message_RU: "Копии: волны" }], //Adicionado
		"s-920-3000-1313-0": [{ type: "text", sub_type: "message", message: "Olas de Agua", message_RU: "Копии: волны" }], //Adicionado
		"s-920-3000-1314-0": [{ type: "text", sub_type: "message", message: "Olas de Agua", message_RU: "Копии: волны" }], //Adicionado
		
		"s-920-3000-2310-0": [{ type: "text", sub_type: "message", message: "Olas de Agua", message_RU: "Копии: волны" }], //Adicionado
		"s-920-3000-2311-0": [{ type: "text", sub_type: "message", message: "Olas de Agua", message_RU: "Копии: волны" }], //Adicionado
		"s-920-3000-2312-0": [{ type: "text", sub_type: "message", message: "Olas de Agua", message_RU: "Копии: волны" }], //Adicionado
		"s-920-3000-2313-0": [{ type: "text", sub_type: "message", message: "Olas de Agua", message_RU: "Копии: волны" }], //Adicionado
		"s-920-3000-2314-0": [{ type: "text", sub_type: "message", message: "Olas de Agua", message_RU: "Копии: волны" }], //Adicionado
		
		
		// color marks in cage
		"ae-0-0-9203037": [{ type: "text", sub_type: "message", message: "Rojo", message_RU: "Красный" }, { type: "func", func: thirdboss_change_colour_event, args: ["red"] }],
		"ae-0-0-9203038": [{ type: "text", sub_type: "message", message: "Amarillo", message_RU: "Желтый" }, { type: "func", func: thirdboss_change_colour_event, args: ["yellow"] }],
