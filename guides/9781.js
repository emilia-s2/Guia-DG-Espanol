...
module.exports = {
	...
	"s-781-1000-2304-0": [{ "type": "text", "sub_type": "message", "message": "Volar", "message_RU": "Взлет" }, { "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 0, 10, 300, 0, 6000] }],
	...
	"s-781-1000-1304-0": [{ "type": "text", "sub_type": "message", "message": "Volar", "message_RU": "Взлет" }, { "type": "spawn_func", "func": "circle", "args": [false, 553, 0, 0, 10, 300, 0, 6000] }],
	...
	"s-781-3000-1116-0": [{ "type": "text", "sub_type": "message", "message": "Empujar Atras | Stun Frontal", "message_RU": "Волны" }],
	"s-781-3000-2116-0": [{ "type": "text", "sub_type": "message", "message": "Empujar Atras | Stun Frontal", "message_RU": "Круг" }],
	"s-781-3000-1136-0": [{ "type": "text", "sub_type": "message", "message": "Claw", "message_RU": "Когти" }],
	"s-781-3000-1701-0": [{ "type": "text", "sub_type": "message", "message": "Empujar atras | Ataque Frontal ", "message_RU": "Назад + Вперед" }],
	...
	"s-781-3000-1152-0": [{ "type": "text", "sub_type": "message", "message": "Stun Frontal | Empujar Atras", "message_RU": "Стан + Откид назад" }],
	"s-781-3000-2152-0": [{ "type": "text", "sub_type": "message", "message": "Stun Frontal | Empujar Atras ", "message_RU": "Стан + Откид назад" }],
