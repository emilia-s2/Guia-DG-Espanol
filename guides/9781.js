...
module.exports = (dispatch, handlers, guide, lang) => {
		...
		switch (skillid) {
			...
			case 1043:
				if (!thirdboss_fifty) {
					handlers.text({
						...
						message_ES: "Debuff (cerca)",
						message_RU: "ДКБ"
					});
				} else {
					handlers.text({
						sub_type: "notification",
						message_ES: "Debuffs > Bombs > Circles",
						message_RU: "ДБК"
					});
				}
				break;
			...
			case 1044:
				if (!thirdboss_fifty) {
					handlers.text({
						sub_type: "notification",
						message_ES: "Circles > Bombs > Debuffs",
						message_RU: "КБД"
					});
				} else {
					handlers.text({
						sub_type: "notification",
						message_ES: "Circles > Debuffs > Bombs",
						message_RU: "КДБ"
					});
				}
				break;
			...
			case 1045:
				if (!thirdboss_fifty) {
					handlers.text({
						sub_type: "notification",
						message_ES: "Bombs > Debuffs > Circles",
						message_RU: "БДК"
					});
				} else {
					handlers.text({
						sub_type: "notification",
						message_ES: "Bombs (juntar + Cleanse)",
						message_RU: "БКД"
					});
				}
				break;
	...
	return {
		...
		"s-781-1000-2304-0": [
			{ type: "text", sub_type: "message", message_ES: "Volar", message_RU: "Взлет" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 300, 0, 6000] }
		],
		"s-781-1000-2303-0": [{ type: "text", sub_type: "message", message_ES: "GIRAR", message_RU: "Крутилка" }],
		"s-781-1000-2301-0": [{ type: "text", sub_type: "message", message_ES: "Veneno General", message_RU: "Крутилка" }],  // Adicionado
		"s-781-1000-2113-0": [{ type: "text", sub_type: "message", message_ES: "Frente + AOEs", message_RU: "Передняя | AOE" }],
		"s-781-1000-2308-0": [{ type: "text", sub_type: "message", message_ES: "SALIR", message_RU: "Наружу" }],
		...
		"s-781-1000-1303-0": [{ type: "text", sub_type: "message", message_ES: "GIRAR", message_RU: "Крутилка" }],
		"s-781-1000-1301-0": [{ type: "text", sub_type: "message", message_ES: "Veneno General", message_RU: "Крутилка" }],  // Adicionado
		"s-781-1000-1113-0": [{ type: "text", sub_type: "message", message_ES: "Frente + AOEs", message_RU: "Передняя | AOE" }],
		"s-781-1000-1308-0": [{ type: "text", sub_type: "message", message_ES: "SALIR", message_RU: "Наружу" }],
		"s-781-1000-1309-0": [{ type: "text", sub_type: "message", message_ES: "ENTRAR", message_RU: "Внутрь" }],
		//"qb-781-1000-78102": [{ type: "text", sub_type: "message", message_ES: "Run away", message_RU: "Уходи!" }],
		//"qb-781-1000-78103": [{ type: "text", sub_type: "message", message_ES: "点名炸石柱", message_RU: "点名炸石柱" }], // круг на одного
		//"qb-781-1000-78106": [{ type: "text", sub_type: "message", message_ES: "集体炸石柱", message_RU: "集体炸石柱" }], // круги на всех
		...
		"s-781-2000-1134-0": [{ type: "text", sub_type: "message", message_ES: "Ataque combo (iframe)", message_RU: "Задний" },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 75, 15, 175, 100, 2000] } // Adicionado
		],
		...
		//"s-781-2000-1121-0": [{ type: "text", sub_type: "message", message_ES: "Summon Mobs", message_RU: "Призыв мобов" }],
		"s-781-2000-1501-0": [
			{ type: "text", sub_type: "message", message_ES: "Identificacion", message_RU: "Идентификация" },
			{ type: "text", sub_type: "message", delay: 1000, message_ES: "3" },
			{ type: "text", sub_type: "message", delay: 2000, message_ES: "2" },
		...
		//"s-781-2000-4000-0": [{ type: "text", sub_type: "alert", message_ES: "鉴定！！！！", message_RU: "Дискотека！" }],
		//"dm-0-0-9781022": [{ type: "text", sub_type: "alert", message_ES: "鉴定", message_RU: "鉴定" }],
		//"dm-0-0-9781023": [{ type: "text", sub_type: "message", message_ES: "全场鉴定", message_RU: "全场鉴定" }],
		"dm-0-0-9781046": [{ type: "text", sub_type: "message", message_ES: "First: (Debuffs) juntar", message_RU: "[ДКБ] Первая: дебафф (ближние)" }], // Thank you... for this release...
		"dm-0-0-9781047": [{ type: "text", sub_type: "message", message_ES: "First: (Circles) Alejar", message_RU: "[КБД] Первая: круги (отдельно)" }], // Beware the... red lightning...
		"dm-0-0-9781048": [{ type: "text", sub_type: "message", message_ES: "First: (Bombs) Juntar + Cleanse", message_RU: "[БДК] Первая: бомбы (вместе + клинс)" }], // Beware the mark... of Lakan...
		...
		"s-781-3000-1404-0": [{ type: "text", sub_type: "message", message_ES: "(Debuff) Cerca", message_RU: "Дебафф (ближние)" }],
		"s-781-3000-1405-0": [{ type: "text", sub_type: "message", message_ES: "(Debuff) Lejos", message_RU: "Дебафф (дальние)" }],
		"s-781-3000-1301-0": [{ type: "text", sub_type: "message", message_ES: "(Bombs) Juntar + Cleanse", message_RU: "Бомбы (вместе!) + клинс" }],
		...
		"s-781-3000-1116-0": [{ type: "text", sub_type: "message", message_ES: "Stun Frontal", message_RU: "Волны" }],
		"s-781-3000-2116-0": [{ type: "text", sub_type: "message", message_ES: "Stun Frontal", message_RU: "Круг" }],
		"s-781-3000-1136-0": [{ type: "text", sub_type: "message", message_ES: "Claw", message_RU: "Когти" }],
		"s-781-3000-1701-0": [{ type: "text", sub_type: "message", message_ES: "Empujar Atras + Frente", message_RU: "Назад + Вперед" }],
		...
		"s-781-3000-1145-0": [{ type: "text", sub_type: "message", message_ES: "ENTRAR", message_RU: "Внутрь" }],
		"s-781-3000-1240-0": [{ type: "text", sub_type: "message", message_ES: "Donuts", message_RU: "Бублики" }, { type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 350, 0, 6000] }],
		"s-781-3000-1401-0": [{ type: "text", sub_type: "message", message_ES: "Plague/Regress", message_RU: "Регресс!!" }],
		"s-781-3000-1402-0": [{ type: "text", sub_type: "message", message_ES: "Dormir", message_RU: "Слип!!" }]
	};
};