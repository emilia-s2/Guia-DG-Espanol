	...
	if ([213, 214].includes(skillid)) { // Ice inside
		dispatch.setTimeout(() => {
			if (debuff != null) {
				handlers["text"]({
					"sub_type": "message",
					"message": (`Hielo (${qbacting_messages[qbacting].message}) | ${mech_messages[(qbacting + debuff + 1) % 2].message}`),
	...
	if ([212, 215].includes(skillid)) { // Fire inside
		dispatch.setTimeout(() => {
			if (debuff != null) {
				handlers["text"]({
					"sub_type": "message",
					"message": (`Fuego (${qbacting_messages[qbacting].message}) | ${mech_messages[(qbacting + debuff) % 2].message}`),
...
//			  ],
	 ...
	 "108-0": [{ "type": "text", "sub_type": "message", "message": "Giro a la Derecha (Derribo!!)", "message_RU": "Поворот вправо (откид!!)" }, { "type": "spawn_func", "func": "circle", "args": [false, 912, 0, 0, 8, 440, 0, 2000] }],  //  Desativado
	 "158-0": [{ "type": "text", "sub_type": "message", "message": "Giro a la Derecha (Derribo!!)", "message_RU": "Поворот вправо (откид!!)" }, { "type": "spawn_func", "func": "circle", "args": [false, 912, 0, 0, 8, 440, 0, 2000] }], // Desativado
	 "109-0": [{ "type": "text", "sub_type": "message", "message": "Giro a la Izquierda (Derribo!!)", "message_RU": "Поворот влево (откид!!)" }, { "type": "spawn_func", "func": "circle", "args": [false, 912, 0, 0, 8, 440, 0, 2000] }], // Desativado
	 "159-0": [{ "type": "text", "sub_type": "message", "message": "Giro a la Izquierda (Derribo!!)", "message_RU": "Поворот влево (откид!!)" }, { "type": "spawn_func", "func": "circle", "args": [false, 912, 0, 0, 8, 440, 0, 2000] }], //  Desativado
...
//	 "206-2": [{"type": "func","func": SpawnCircle.bind(null,false,445,0,0,15,350,0,3000)}],
	 ...
	 "139-0": [{ "type": "text", "sub_type": "message", "message": "[Temperatura] 60+ TODOS (HIELO)", "message_RU": "60° (Огонь всем)" }],
	 "140-0": [{ "type": "text", "sub_type": "message", "message": "[Temperatura] 40- TODOS (FUEGO)", "message_RU": "40° (Лед всем)" }],
	//
