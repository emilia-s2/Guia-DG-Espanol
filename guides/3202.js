...
module.exports = (dispatch, handlers, guide, lang) => {
	return {
		...
		"s-3202-1000-107-0": [{ type: "text", sub_type: "message", message_ES: "Lanza Spectral", message_RU: "Спектральный бросок (байт)" },
		    { type: "text", sub_type: "message", delay: 1390, message_ES: "Iframe!", message_RU: "Эвейд!" }
        ],
		// Basic attacks
		"s-3202-1000-103-0": [{ type: "text", sub_type: "message", message_ES: "2 Hits | Sangrar", message_RU: "2 удара | Кровоток" }],
		"s-3202-1000-113-0": [{ type: "text", sub_type: "message", message_ES: "4 Hits Combo", message_RU: "4 удара комба" }],
		"s-3202-1000-105-0": [{ type: "text", sub_type: "message", message_ES: "Gancho | Stun", message_RU: "Удар снизу | Стан" }],
		...
		"s-3202-1000-120-0": [
			...
			{ type: "text", sub_type: "message", delay: 2100, message_ES: "Iframe!", message_RU: "Эвейд!" },
...
//			{ type: "text", sub_type: "message", delay: 3000, message_ES: "Gather!", message_RU: "Собраться!" }
		...
		"s-3202-1000-121-0": [
			{ type: "text", sub_type: "message", message_ES: "Pizza Pie Derecho + Ola DENTRO", message_RU: "Пицца (правая нога) | Волны наружу: От него > К нему" },
...
//			{ type: "text", sub_type: "message", delay: 1900, message_ES: "Dodge!", message_RU: "Эвейд!" }
		],
		...
		"s-3202-1000-123-0": [
			...
			{ type: "text", sub_type: "message", delay:100, message_ES: "Ola DENTRO", message_RU: "[Волны наружу: От него > К нему]" }
		],
		"s-3202-1000-127-0": [
//			{ type: "text", sub_type: "message", message_ES: "Out-waves: Stay Out > Get In", message_RU: "Волны наружу: От него > К нему" },
		...
		"s-3202-1000-124-0": [
			{ type: "text", sub_type: "message", message_ES: "Pizza Pie Izquierdo + Ola FUERA", message_RU: "Пицца (левая нога) | Волны внутрь: К нему > От него" },
//			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 550, 0, 3000] },
//			{ type: "spawn", func: "semicircle", args: [-60, 70, 912, 0, 0, 8, 450, 0, 4000] },
//			{ type: "spawn", func: "semicircle", args: [120, 250, 912, 0, 0, 8, 450, 0, 4000] },
			{ type: "spawn", func: "vector", args: [912, 0, 0, 60, 450, 0, 4000] },
...
//			{ type: "text", sub_type: "message", delay: 1900, message_ES: "Dodge!", message_RU: "Эвейд!" }
		...
		"s-3202-1000-126-0": [
			...
			{ type: "spawn", func: "vector", args: [912, 0, 0, 85, 550, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [85, 295, 553, 0, 0, 6, 550, 0, 1500] },
			{ type: "text", sub_type: "message", delay:100, message_ES: "Ola FUERA", message_RU: "[Волны внутрь: К нему > От него]" }
		],
		"s-3202-1000-128-0": [
//			{ type: "text", sub_type: "message", message_ES: "In-waves: Stay In > Get Out", message_RU: "Волны внутрь: К нему > От него" },
