...
module.exports = (dispatch, handlers, guide, lang) => {
	return {
		...
		"s-3202-1000-107-0": [{ type: "text", sub_type: "message", message: "Lanza Spectral", message_RU: "Спектральный бросок (байт)" }],
...
//			{ type: "text", sub_type: "message", delay: 3000, message: "Gather!", message_RU: "Собраться!" }
		...
		"s-3202-1000-112-0": [
			{ type: "text", sub_type: "message", message: "Frente | Atras Patada", message_RU: "Разворот | Откид назад" },
		...
		"s-3202-1000-110-0": [
			{ type: "text", sub_type: "message", message: "Ola DENTRO", message_RU: "Бублики + Волна" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 6, 650, 0, 4000] },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 10, 320, 0, 4000] }
		],
		"s-3202-1000-109-0": [
			{ type: "text", sub_type: "message", message: "Tumbar + Girar", message_RU: "Опрокид + Крутилка" },
		...
		"s-3202-1000-121-0": [
			{ type: "text", sub_type: "message", message: "Pizza Pie Derecho + Ola DENTRO", message_RU: "Пицца (правая нога) | Волны наружу: От него > К нему" },
...
//			{ type: "text", sub_type: "message", delay: 1900, message: "Dodge!", message_RU: "Эвейд!" }
		...
		"s-3202-1000-123-0": [
			...
			{ type: "text", sub_type: "message", delay:100, message: "Ola DENTRO", message_RU: "[Волны наружу: От него > К нему]" }
		],
		"s-3202-1000-127-0": [
//			{ type: "text", sub_type: "message", message: "Out-waves: Stay Out > Get In", message_RU: "Волны наружу: От него > К нему" },
		...
		"s-3202-1000-124-0": [
			{ type: "text", sub_type: "message", message: "Pizza Pie Izquierdo + Ola FUERA", message_RU: "Пицца (левая нога) | Волны внутрь: К нему > От него" },
//			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 550, 0, 3000] },
//			{ type: "spawn", func: "semicircle", args: [-60, 70, 912, 0, 0, 8, 450, 0, 4000] },
//			{ type: "spawn", func: "semicircle", args: [120, 250, 912, 0, 0, 8, 450, 0, 4000] },
			{ type: "spawn", func: "vector", args: [912, 0, 0, 60, 450, 0, 4000] },
...
//			{ type: "text", sub_type: "message", delay: 1900, message: "Dodge!", message_RU: "Эвейд!" }
		...
		"s-3202-1000-126-0": [
			...
			{ type: "spawn", func: "vector", args: [912, 0, 0, 85, 550, 0, 1500] },
			{ type: "spawn", func: "semicircle", args: [85, 295, 553, 0, 0, 6, 550, 0, 1500] },
			{ type: "text", sub_type: "message", delay:100, message: "Ola FUERA", message_RU: "[Волны внутрь: К нему > От него]" }
		],
		"s-3202-1000-128-0": [
