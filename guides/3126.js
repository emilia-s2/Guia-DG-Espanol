...
/*				handlers.text({
	...
	const skills = {
		...
		"108-0": [
			{ type: "text", sub_type: "message", message: "Giro a la Derecha (Derribo!!)", message_RU: "Поворот вправо (откид)" },
...
//		"118-1": [{ type: "text", sub_type: "message", message: "Dodge", message_RU: "Эвейд!" }],
		...
		// AOE лед (малый)
		"154-0": [{ type: "text", sub_type: "message", message: "Magia de HIELO (Pequeno)", message_RU: "Ледяной шторм" }, { type: "spawn", func: "circle", args: [false, 553, 0, 80, 8, 520, 0, 6500] }],
		// AOE огонь (малый)
...
//		"206-2": [{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 15, 350, 0, 3000] }],
		...
		"139-0": [
			{ type: "text", sub_type: "message", message: "60+ Todos (Fuego)", message_RU: "60° (Огонь всем)" },
			{ type: "text", sub_type: "message", delay: 4000, message: "Abaja la temperatura", message_RU: "Снизить температуру" }
		],
		"140-0": [
		...
		"am-3126-1000-31260068": [
			...
			{ type: "text", sub_type: "message", delay: 145000, message: "[Debuff] 2.5 minutos pasado", message_RU: "[Дебафф] Прошло 2.5 минуты (стаки удалены)" }
		]
	};
