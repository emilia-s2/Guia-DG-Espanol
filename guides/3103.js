	...
	if ([31031007, 32031007].includes(skillid)) { // "Ha" attacks
		if (print_target) {
			...
			timer1 = dispatch.setTimeout(() => {
				handlers["text"]({
					"sub_type": "alert",
					"message": "El objetivo atacar pronto...",
...
module.exports = {
	...
	"s-3103-1000-113-0": [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Patada Circular", "message_RU": "Удар с разворота" }],
	"s-3103-1000-111-0": [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Tumbar", "message_RU": "Опрокид" }],
	"s-3103-1000-120-0": [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Tumbar", "message_RU": "Опрокид" }],
	//"s-3103-1000-102-0": [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Combo", "message_RU": "Комба" }], // 102 153/154 115/116
	"s-3103-1000-153-0": [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Dos Patadas", "message_RU": "Два удара" }], // 153 108
	...
	"s-3103-1000-121-0": [{ "type": "text", "sub_type": "message", "message": "Giro + Patada(Stun)", "message_RU": "Удар в воздухе (стан)" }],
	...
	"s-3103-1000-114-0": [{ "type": "text", "sub_type": "message", "message": "Salto (Tumbar)", "message_RU": "Прыжок (опрокид)" }, { "type": "spawn_func", "func": "circle", "args": [true, 553, 0, 0, 12, 240, 0, 2000] }],
	...
	"s-3103-1000-131-0": [{ "type": "text", "sub_type": "message", "message": "Ritmico Golpes", "message_RU": "Ураганная серия" }], // 131 132 133
	 // 116 146
	"s-3103-1000-146-0": [
		{ "type": "text", "sub_type": "message", "message": "Patada Atras", "message_RU": "Откид назад" },
	...
	"qb-3103-1000-31031007": [
		{ "type": "text", "sub_type": "message", "message": "objetivo", "message_RU": "Таргет" },
		{ "type": "func", "func": skilld_event.bind(null, 31031007) }
	],
	"s-3103-1000-124-0": [{ "type": "text", "sub_type": "message", "message": "Patada", "message_RU": "Удар" }], // 305 124
	"s-3103-1000-125-0": [{ "type": "text", "sub_type": "message", "message": "Patada", "message_RU": "Удар" }],

	// Donuts
	"qb-3103-1000-31031008": [{ "type": "text", "sub_type": "message", "message": "SALIR - ENTRAR (Donuts)", "message_RU": "Бублики: От него > К нему > Эвейд" }], // 31031008 303/304 117 155
	"qb-3103-1000-31031009": [{ "type": "text", "sub_type": "message", "message": "ENTRAR - SALIR (Donuts)", "message_RU": "Бублики: К нему > От него > Эвейд" }], // 31031009 303/304 118 155
	"s-3103-1000-303-0": [
	...
	// Stun 142 148 129
	"s-3103-1000-142-0": [{ "type": "text", "sub_type": "message", "message": "Ola Atras (Stun)", "message_RU": "Стан | Волна назад" }],
	...
	// Jump 143-0 143-1
	"s-3103-1000-143-0": [{ "type": "text", "sub_type": "message", "message": "Salto (Stun)", "message_RU": "Прыжок (стан)" }],
