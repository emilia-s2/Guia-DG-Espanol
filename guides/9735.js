...
module.exports = (dispatch, handlers, guide, lang) => {
	return {
		...
		"s-735-1000-111-0": [{ type: "text", sub_type: "message", message_ES: "Frente + Atrás", message_RU: "Удар назад + вперед" }],
		"s-735-1000-104-0": [{ type: "text", sub_type: "message", message_ES: "Stun Frontal", message_RU: "Передний зажим" }],
		"s-735-1000-112-0": [{ type: "text", sub_type: "message", message_ES: "Ataque Atras", message_RU: "Удар назад" }],
		"s-735-1000-304-0": [{ type: "text", sub_type: "message", message_ES: "SALIR", message_RU: "От него" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 350, 100, 4000] } // Adicionado
		],
		"s-735-1000-305-0": [{ type: "text", sub_type: "message", message_ES: "ENTRAR", message_RU: "К нему" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 0, 8, 290, 100, 4000] } // Adicionado
		],
		"s-735-1000-306-0": [{ type: "text", sub_type: "message", message_ES: "Bombs", message_RU: "Бомбы" }],
		"s-735-1000-307-0": [{ type: "text", sub_type: "message", message_ES: "Jalar", message_RU: "Стяжка" }],
		"s-735-1000-309-0": [{ type: "text", sub_type: "message", message_ES: "Misiles Iniciados!!", message_RU: "Запуск 4 ракет" },
			{ type: "text", sub_type: "message", delay: 12000, message_ES: "Disparar Misiles", message_RU: "Эвейд" } // Adicionado
		],
		...
		"s-735-2000-102-0": [
			{ type: "text", sub_type: "message", message_ES: "Frente Ataque", message_RU: "Пила (Эвейд)" },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 300, 12, 228, 0, 3000] }
		],
		"s-735-2000-105-0": [
			{ type: "text", sub_type: "message", message_ES: "Girar (Repeler)", message_RU: "Крутилка (откид)" },
		...
		"s-735-2000-301-0": [{ type: "text", sub_type: "message", message_ES: "Jugar (Bombs)", message_RU: "Бомба" },
		    { type: "spawn", func: "circle", args: [false, 553, 0, 0, 12, 200, 100, 6000] } // Adicionado
		],	
		"s-735-2000-304-0": [
			{ type: "text", sub_type: "message", message_ES: "SALIR (Explosion)", message_RU: "От него" },
		...
		"s-735-3000-116-0": [{ type: "text", sub_type: "message", message_ES: "S-DERECHA Seguro", message_RU: "Справа сейф" },
		...
		"s-735-3000-117-0": [{ type: "text", sub_type: "message", message_ES: "S-IZQUIERDA Seguro", message_RU: "Слева сейф" },
		...
		"s-735-3000-118-0": [{ type: "text", sub_type: "message", message_ES: "S-IZQUIERDA Seguro", message_RU: "Слева сейф" },
			{ type: "spawn", func: "vector", args: [553, 10, 210, 0, 290, 0, 3000] },
			{ type: "spawn", func: "point", args: [553, 20, 210, 0, 3000] },
			{ type: "spawn", func: "point", args: [553, 30, 220, 0, 3000] },
			{ type: "spawn", func: "point", args: [553, 40, 230, 0, 3000] },
		...
		"s-735-3000-119-0": [{ type: "text", sub_type: "message", message_ES: "S-DERECHA Seguro", message_RU: "Справа сейф" },
			{ type: "spawn", func: "point", args: [553, 120, 250, 0, 3000] },
			{ type: "spawn", func: "point", args: [553, 130, 240, 0, 3000] },
			{ type: "spawn", func: "point", args: [553, 140, 230, 0, 3000] },
			{ type: "spawn", func: "point", args: [553, 150, 220, 0, 3000] },
		...
		"s-735-3000-128-0": [
			{ type: "text", sub_type: "message", message_ES: "Atras Puno Esxplosivo", message_RU: "Комба | Конус назад" },
			{ type: "spawn", func: "vector", args: [553, 180, 40, 120, 900, 2000, 3000] },
			{ type: "spawn", func: "vector", args: [553, 180, 40, 240, 900, 2000, 3000] }
		],
		"s-735-3000-129-0": [{ type: "text", class_position: "tank", sub_type: "message", message_ES: "Esquiva", message_RU: "Эвейд" }],
	    "s-735-3000-321-0": [
