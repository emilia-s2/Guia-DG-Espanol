...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"qb-3040-1000-32042000": [
			...
			{ type: "text", sub_type: "alert", message: "Esquiva", message_ES: "Esquiva", delay: 1450 },
			{ type: "func", func: () => combo_count = 0 }
		],
		"h-3040-1000-35": [{ type: "text", sub_type: "message", message: "35%", message_ES: "35%" }],
		"qb-3040-1000-32041000": [{ type: "text", sub_type: "alert", message: "combo Pizza em Breve", message_ES: "Combo Pizza en Breve" }],
		...
		"s-3040-1000-107-0": [
			{ type: "text", sub_type: "message", message: "Line Forward + Side Lines", message_ES: "Líneas en Medio y Laterales + PIZZA" },
		...
		"s-3040-1000-112-0": [{ type: "text", sub_type: "message", message: "Wave Forward", message_ES: "Empujar a Frente" },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 70, 500, 0, 2000] },
			{ type: "spawn", func: "vector", args: [553, 0, 0, 290, 500, 0, 2000] }
		],
		"s-3040-1000-114-0": [{ type: "text", sub_type: "message", message: "Inner + Outer AOEs", message_ES: "AOEs Dentro y Fuera + GIRO" }],
		"s-3040-1000-116-0": [
		...
		"s-3040-1000-119-0": [{ type: "text", sub_type: "message", message: "Two Strikes", message_ES: "Dos Golpes" }],
		"s-3040-1000-120-0": [
			{ type: "text", sub_type: "message", message: "Two Strikes + Stun (AOE)", message_ES: "Explosión Ampla Stun" },
			{ type: "text", sub_type: "message", message: "Esquiva", message_ES: "Iframe", delay: 2250 },
			{ type: "spawn", func: "circle", args: [true, 553, 180, -100, 10, 700, 0, 2500], delay: 1500 }
		],
		"s-3040-1000-123-0": [{ type: "text", sub_type: "message", message: "Spin", message_ES: "Giro" }],
		...
		"s-3040-1000-156-0": [{ type: "text", sub_type: "message", message: "Get Skulls", message_ES: "Cabezas" }],
		"s-3040-1000-157-0": [{ type: "text", sub_type: "alert", message: "Gather!", message_ES: "Juntar!", delay: 5000 }],
		"s-3040-1000-158-0": [{ type: "text", sub_type: "alert", message: "Gather!", message_ES: "Juntar!", delay: 5000 }],
