	...
	function boss_mech_event(skillid) {
		...
		if (skillid == 120) {
			...
			if (purple && !boss_thirty) {
				handlers.event([
					{ type: "text", sub_type: "message", message_ES: "ENTRAR - SALIR - ENTRAR", message_RU: "К нему > От него > К нему" },
					// бублик перед боссом
			...
			// к нему (бублик вокруг босса) -> от него (круг перед боссом) -> [волны] -> к нему (бублик перед боссом)
				...
				handlers.event([
					{ type: "text", sub_type: "message", message_ES: "ENTRAR - SALIR - SALIR", message_RU: "К нему > От него > (К нему)" },
//					{ type: "text", sub_type: "message", delay: 5000, message_ES: "In", message_RU: "К нему" },
					// бублик перед боссом
		...
		if (skillid == 123) {
			...
			if (green && !boss_thirty) {
				handlers.event([
					{ type: "text", sub_type: "message", message_ES: "SALIR - ENTRAR - SALIR", message_RU: "От него > К нему > От него" },
			...
			// к нему (бублик вокруг босса) -> от него (круг перед боссом) -> от него (большой круг перед боссом)
				...
				handlers.event([
					{ type: "text", sub_type: "message", message_ES: "ENTRAR - SALIR - SALIR", message_RU: "К нему > От него > От него" },
					// большой круг перед боссом
					{ type: "spawn", func: "circle", args: [true, 912, 0, 200, 8, 450, 5000, 3000] } // 3
				]);
			...
			// от него (круг перед боссом) -> к нему (бублик вокруг босса) -> [волны] -> от него (большой круг перед боссом)
				...
				handlers.event([
					{ type: "text", sub_type: "message", message_ES: "SALIR - ENTRAR - SALIR", message_RU: "От него > К нему > (От него)" },
//					{ type: "text", sub_type: "message", delay: 5000, message_ES: "Out", message_RU: "От него" },
					// большой круг перед боссом
...
//					{ type: "text", sub_type: "message", delay: 5000, message_ES: "Out", message_RU: "От него" },
		...
		if (skillid == 127) {
			if (boss_thirty)
				handlers.text({ sub_type: "message", message_ES: "Salto | Salir", message_RU: "Прыжок | От него" });
			else
				handlers.event([
					{ type: "text", sub_type: "message", message_ES: "salto | Entrar", message_RU: "Прыжок | К нему" },
	...
	const debuffs_targe = {
		30209101: { message_ES: "Rayo", message_RU: "Молния (эвейд)" },
		30209102: { message_ES: "Bruja", message_RU: "Ведьма (эвейд)" }
	};
				...
				if (player.isMe(event.target.toString()) || player.playersInParty.includes(event.target.toString())) {
					if (added) {
						...
						debuff_call_event = dispatch.setTimeout(() => {
							handlers.text({
								sub_type: "alert",
								message_ES: debuffs_targe[event.id].message,
	...
	return {
		...
		// 1 BOSS
		"s-3020-1900-104-0": [
			{ type: "text", sub_type: "message", message_ES: "Succion (Esquiva)", message_RU: "Высасывание (Выйти)" },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 0, 10, 450, 200, 6000] }
		],

		// 2 BOSS
		"s-3020-1200-103-0": [{ type: "text", sub_type: "message", message_ES: "Succion (Esquiva)", message_RU: "Высасывание" }],
		...
		"h-3020-2200-30": [
			{ type: "text", sub_type: "message", message_ES: "30%", message_RU: "30%" },
		...
		"s-3020-2200-108-0": [
			{ type: "text", sub_type: "message", message_ES: "Frente (Stun)", message_RU: "Стан" },
			{ type: "spawn", func: "circle", args: [true, 553, 0, 170, 20, 120, 200, 2000] }
		],
		//"s-3020-9101-122-0": [{ type: "text", sub_type: "message", message_ES: "Jump", "message_TW": "强袭" }],
		//"s-3020-9101-124-0": [{ type: "text", sub_type: "message", message_ES: "Jump", "message_TW": "前砸" }],
		//"s-3020-9101-125-0": [{ type: "text", sub_type: "message", message_ES: "Jump", "message_TW": "转圈" }],
		//"s-3020-9101-126-0": [{ type: "text", sub_type: "message", message_ES: "Jump", "message_TW": "大前砸" }],
		//"s-3020-2201-121-0": [{ type: "text", sub_type: "message", message_ES: 'Left swipe', "message_TW": "2201-121" }, { type: "spawn", func: "marker", args: [false, 0, 0, 100, 2000, true, null] }],  
		//"s-3020-2201-125-0": [{ type: "text", sub_type: "message", message_ES: 'Left swipe', "message_TW": "2201-125" }, { type: "spawn", func: "marker", args: [false, 0, 0, 100, 2000, true, null] }],  
		//"s-3020-2201-126-0": [{ type: "text", sub_type: "message", message_ES: 'Left swipe', "message_TW": "2201-126" }, { type: "spawn", func: "marker", args: [false, 0, 0, 100, 2000, true, null] }],  
		//"s-3020-2201-201-0": [{ type: "spawn", func: "marker", args: [false, 0, 0, 100, 2000, true, null] }],
		//"s-3020-6103-203-0": [{ type: "text", sub_type: "message", message_ES: 'Left swipe', "message_TW": "6103-203" }, { type: "spawn", func: "marker", args: [false, 0, 0, 100, 2000, true, null] }],  
		//"s-3020-6103-202-0": [{ type: "text", sub_type: "message", message_ES: 'Left swipe', "message_TW": "6103-202" }, { type: "spawn", func: "marker", args: [false, 0, 0, 100, 2000, true, null] }],  
		//"s-3020-6103-201-0": [{ type: "text", sub_type: "message", message_ES: 'Left swipe', "message_TW": "6103-201" }, { type: "spawn", func: "marker", args: [false, 0, 0, 100, 2000, true, null] }],   
		"s-3020-2200-127-0": [{ type: "func", func: boss_mech_event, args: [127] }],
		"s-3020-2200-128-0": [{ type: "text", sub_type: "message", message_ES: "Golfe (volar)", message_RU: "Черкаш (подлет)" }],
		"s-3020-2200-129-0": [
			{ type: "text", sub_type: "message", message_ES: "Martillo Aplastar", message_RU: "Полоса в цель" },
			{ type: "spawn", func: "vector", args: [553, 90, 80, 0, 500, 200, 2000] },
			{ type: "spawn", func: "vector", args: [553, 270, 80, 0, 500, 200, 2000] }
		],
		//"s-3020-2200-131-0": [{ type: "text", sub_type: "message", message_ES: "Jump", message_RU: "Прыжок" }],
		"s-3020-2200-133-1": [
		...
		"s-3020-2200-135-0": [{ type: "text", sub_type: "message", message_ES: "Saltar Cuerda", message_RU: "Волны х5" }],

		"s-3020-2200-137-0": [{ type: "text", sub_type: "message", message_ES: "Difundir", message_RU: "Волна от" }],
		"s-3020-2200-139-0": [{ type: "text", sub_type: "message", message_ES: "Encogerse", message_RU: "Волна к" }],

		"s-3020-2200-202-0": [{ type: "text", sub_type: "message", message_ES: "Defence 3 seconds", message_RU: "Защита 3 сек." }],
		"s-3020-2200-203-0": [{ type: "text", sub_type: "message", message_ES: "Defence 10 seconds", message_RU: "Защита 10 сек." }],
		"s-3020-2200-204-0": [{ type: "text", sub_type: "message", message_ES: "30% (Transformar)", message_RU: "30% (видоизменение)" }]
	};
};