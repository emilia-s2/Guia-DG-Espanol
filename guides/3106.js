...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		// "s-3106-1000-105-0": [{ type: "text", sub_type: "message", message: "Knockback Spin", message_ES: "Оборот (откид)", check_func: () => combo_start === true }],
		...
		"s-3106-1000-202-0": [{ type: "text", sub_type: "message", message: "Front", message_ES: "Frente" }],
		"s-3106-1000-203-0": [{ type: "text", sub_type: "message", message: "Front + Wave", message_ES: "Frente + Ola" }],
