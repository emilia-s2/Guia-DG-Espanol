...
//		"s-3201-2000-150-0": [{ type: "text", sub_type: "message", message: "Phantom", message_RU: "Фантом" }],
		...
		"am-3201-320126-32010224": [
			{ type: "text", sub_type: "alert", delay: 52000, message: "REAL Debuff en 5 secundos", message_RU: "След. правда" },
			{ type: "func", func: secondboss_debuff_event, args: [32010224] }
		],
		"am-3201-2000-32010220": [
			{ type: "text", sub_type: "alert", delay: 52000, message: "FAKE Debuff en 5 secundos", message_RU: "След. ложь" },
