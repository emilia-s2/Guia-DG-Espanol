...
/*		"s-3201-1000-143-0": [
		...
		"s-3201-1000-311-0": [
			{ type: "text", sub_type: "message", message: "Ataque en Pantalla Llena (Lento)", message_RU: "Правая рука (подлет)" },
			{ type: "text", sub_type: "message", delay: 4200, message: "Iframe", message_RU: "Откид!" }
		],
		"s-3201-1000-312-0": [
			{ type: "text", sub_type: "message", message: "Ataque en Pantalla Llena (Radio)", message_RU: "Правая рука (подлет)" },
			{ type: "text", sub_type: "message", delay: 2200, message: "Iframe", message_RU: "Откид!" }
		],
		"s-3201-1000-313-0": [
			{ type: "text", sub_type: "message", message: "DENTRO y FUERA (Lento)", message_RU: "Кольцо" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 75, 10, 300, 0, 6000] }
		],
		"s-3201-1000-314-0": [
			{ type: "text", sub_type: "message", message: "DENTRO y FUERA (Rapido)", message_RU: "Кольцо (фаст)" },
			{ type: "spawn", func: "circle", args: [false, 553, 0, 75, 10, 300, 0, 6000] }
		],
		...
		"am-3201-320126-32010224": [
			{ type: "text", sub_type: "alert", delay: 52000, message: "REAL Debuff en 5 secundos", message_RU: "След. правда" }, //Alterado
			{ type: "func", func: secondboss_debuff_event, args: [32010224] }
		],
		"am-3201-2000-32010220": [
			{ type: "text", sub_type: "alert", delay: 52000, message: "FAKE Debuff en 5 secundos", message_RU: "След. ложь" },   //Alterado
