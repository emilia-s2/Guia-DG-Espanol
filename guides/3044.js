...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3044-1000-110-0": [{ type: "text", sub_type: "message", message: "Throw Front (Stun)", message_ES: "Lanzar Frente (Stun)" }],
		...
		"s-3044-1000-125-0": [{ type: "text", sub_type: "message", message: "Hit | Frontal Stun", message_ES: "Golpe Frente | Stun" }],
		"s-3044-1000-126-0": [
		...
		"s-3044-1000-129-0": [{ type: "text", sub_type: "message", message: "Somersault | Back Hit", message_ES: "Salto Mortal | Golpe Atrás" }],
		"s-3044-1000-130-0": [
		...
		"s-3044-1000-142-0": [{ type: "text", sub_type: "message", message: "Frontal Combo", message_ES: "Combo Frontal" }],
		...
		"s-3044-2000-110-0": [{ type: "text", sub_type: "message", message: "Throw Front (Stun)", message_ES: "Lanzar Frente (Stun)" }],
		...
		"s-3044-2000-125-0": [{ type: "text", sub_type: "message", message: "Hit | Frontal Stun", message_ES: "Golpe Frente | Stun" }],
		"s-3044-2000-126-0": [
			{ type: "text", sub_type: "message", message: "Frontal Stun", message_ES: "Frente Stun" },
			{ type: "spawn", func: "vector", args: [553, 60, 220, 20, 500, 0, 2000] },
			{ type: "spawn", func: "vector", args: [553, 300, 220, 340, 500, 0, 2000] }
		],
		"s-3044-2000-129-0": [{ type: "text", sub_type: "message", message: "Somersault | Back Hit", message_ES: "Salto Mortal | Golpe Atrás" }],
		"s-3044-2000-130-0": [
			{ type: "text", sub_type: "message", message: "Back Hit (Bleed)", message_ES: "Golpe Atrás (Sangrar)" },
			{ type: "spawn", func: "circle", args: [true, 553, 180, 340, null, 250, 0, 2000] }
		],
		"s-3044-2000-142-0": [{ type: "text", sub_type: "message", message: "Frontal Combo", message_ES: "Combo Frontal" }],
		"s-3044-2000-143-0": [{ type: "text", sub_type: "message", message: "Hit | Back Push", message_ES: "Golpe | Empujón Hacia Atrás" }],
		"s-3044-2000-143-1": [{ type: "text", sub_type: "message", message: "Back Push", message_ES: "Empujón Hacia Atrás" }],
		"s-3044-2000-144-0": [
		...
		"qb-3044-2000-3044201": [{ type: "text", sub_type: "message", message: "Blue Circles (Safe)", message_ES: "Círculos Azules  (Seguro)" }],
		"qb-3044-2000-3044202": [{ type: "text", sub_type: "message", message: "Red Circles (Dodge)", message_ES: "Círculos Rojos  (Esquiva)" }],
		"qb-3044-2000-3044400": [{ type: "text", sub_type: "message", message: "Break Statues", message_ES: "Romper  Escudos de las Estatuas" }]
	};
};