...
module.exports = (dispatch, handlers, guide, lang) => {
	return {
		...
		"s-620-1000-107-0": [{ type: "text", sub_type: "message", message_ES: "Ataque (Atras)", message_RU: "no se russo :c sorry" }],
		...
		"s-620-1000-209-0": [{ type: "text", sub_type: "message", message_ES: "Regresar al Medio + Bolas de Fuego", message_RU: "no se russo :c sorry" }],
		"s-620-1000-125-0": [{ type: "text", sub_type: "message", message_ES: "Bolas de Fuego", message_RU: "Поворот + дыхание" }],
		
		"s-620-1001-303-0": [{ type: "text", sub_type: "message", message_ES: "AOE", message_RU: "no se russo :c sorry" }],
