...
module.exports = (dispatch, handlers, guide, lang) => {
	return {
		...
		"s-620-1002-303-0": [{ type: "text", sub_type: "message", message: "AOE", message_RU: "no se russo :c sorry" }],
		"s-620-1003-303-0": [{ type: "text", sub_type: "message", message: "AOE", message_RU: "no se russo :c sorry" }],
		"s-620-1004-303-0": [{ type: "text", sub_type: "message", message: "AOE", message_RU: "no se russo :c sorry" }],
		"s-620-1005-303-0": [{ type: "text", sub_type: "message", message: "AOE", message_RU: "no se russo :c sorry" }],
