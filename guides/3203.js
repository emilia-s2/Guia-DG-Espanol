...
function skilld_event(skillid, handlers, event, ent, dispatch) {
	...
	if (skillid == 116) { // Haymaker
		if (in_bait) {
			handlers["text"]({
				"sub_type": "message",
				"message": "Golpe Random (Haymaker)",
				"message_RU": "Мощный удар"
			});
		} else { // 116 -> 146
			handlers["text"]({
				"sub_type": "message",
				"message": "Golpe Frontal + Patada Atras (Haymaker)",
	...
	if ([31031007, 32031007].includes(skillid)) { // "Ha" attacks
		if (print_target) {
			...
			timer1 = dispatch.setTimeout(() => {
				handlers["text"]({
					"sub_type": "alert",
					"message": "El objetivo atacara pronto...",
...
module.exports = {
	...
	"s-3203-1000-113-0": [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Patada Circular", "message_RU": "Удар с разворота" }],
	"s-3203-1000-111-0": [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Tumbar", "message_RU": "Опрокид" }],
	"s-3203-1000-120-0": [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Tumbar", "message_RU": "Опрокид" }],
	//"s-3203-1000-102-0": [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Combo", "message_RU": "Комба" }], // 102 153/154 115/116
	"s-3203-1000-153-0": [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Dos Patada", "message_RU": "Два удара" }], // 153 108
	...
	"s-3203-1000-121-0": [{ "type": "text", "sub_type": "message", "message": "Giro + Patada(Stun)", "message_RU": "Удар в воздухе (стан)" }],
	...
	"s-3203-1000-114-0": [{ "type": "text", "sub_type": "message", "message": "Salto (Tumbar)", "message_RU": "Прыжок (опрокид)" }, { "type": "spawn_func", "func": "circle", "args": [true, 553, 0, 0, 12, 240, 0, 2000] }],
	...
	"s-3203-1000-146-0": [
		{ "type": "text", "sub_type": "message", "message": "Patada Aras", "message_RU": "Откид назад" }, // 116 146
	...
	"qb-3203-1000-32031007": [{ "type": "text", "sub_type": "message", "message": "objetivo", "message_RU": "Таргет" }, { "type": "func", "func": skilld_event.bind(null, 32031007) }],
	"s-3203-1000-124-0": [{ "type": "text", "sub_type": "message", "message": "Patada", "message_RU": "Удар" }], // 305 124
	"s-3203-1000-125-0": [{ "type": "text", "sub_type": "message", "message": "Patada", "message_RU": "Удар" }],

	// Donuts
	"qb-3203-1000-32031008": [{ "type": "text", "sub_type": "message", "message": "SALIR - ENTRAR (Donuts_)", "message_RU": "Бублики: От него > К нему > Эвейд" }], // 32031008 303/304 117 155
	"qb-3203-1000-32031009": [{ "type": "text", "sub_type": "message", "message": "ENTRAR - SALIR (Donuts)", "message_RU": "Бублики: К нему > От него > Эвейд" }], // 32031009 303/304 118 155
	"s-3203-1000-303-0": [
	...
	// Stun 142 148 129
	"s-3203-1000-142-0": [{ "type": "text", "sub_type": "message", "message": "Ola Atras | Stun", "message_RU": "Стан | Волна назад" }],
	"s-3203-1000-148-0": [{ "type": "spawn_func", "func": "circle", "args": [true, 912, 0, -10, 12, 300, 0, 3000] }],
	"s-3203-1000-129-0": [
		{ "type": "text", "sub_type": "message", "message": "Ola Atras", "message_RU": "Волна назад (откид)" },
	...
	// Jump 143-0 143-1
	"s-3203-1000-143-0": [{ "type": "text", "sub_type": "message", "message": "Salto (Stun)", "message_RU": "Прыжок (стан)" }],
	...
	"s-3203-1000-314-0": [
		{ "type": "text", "sub_type": "message", "message": "SALIR", "message_RU": "Выйти" },
	...
	"s-3203-1000-152-0": [
		...
		{ "type": "text", "sub_type": "alert", "delay": 58000, "message": "Explosion Pronto...", "message_RU": "Скоро взрыв..." }
	],
	"s-3203-1000-135-0": [
		{ "type": "text", "sub_type": "message", "message": "Explosion (Stun)", "message_RU": "Взрыв (стан)" },
		{ "type": "spawn_func", "func": "circle", "args": [true, 912, 0, 0, 8, 460, 0, 2500] },
